...
public class SuggestedItinariesActivity extends Activity implements SuggestedItinariesFragment.OnFragmentInteractionListener{
        ...
        if (savedInstanceState == null) {
            ...
            if(bundle != null) {
                getFragmentManager().beginTransaction()
                        .add(R.id.container, SuggestedItinariesFragment.newInstance(bundle))
                        .commit();
            }
